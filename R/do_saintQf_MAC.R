#' system.file("extdata/mac", "saintq.exe", package = "ibqreader")
#' this does everything to do a saintQ fragment based analysis with a mac
#' @export
#'
ibq_saintQfrag_MAC <- function(combine_gene_sequence){
  ...
  saintexe <- system.file("extdata/mac", "saintq", package = "ibqreader") %>% str_replace_all("/", "\\\\")
